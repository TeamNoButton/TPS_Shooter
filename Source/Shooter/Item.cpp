...
void AItem::BeginPlay()
{
	...
	// Sets ActiveStars arrya based on Item Rarity
	SetActiveStars();
...
void AItem::ItemInterp(float DeltaTime)
{
	...
	if (Character && ItemZCurve)
	{
		...
		// Vector form Item to Camera Interp Location, X and Y are zeroed out
...
void AItem::StartItemCurve(AShooterCharacter* Char, bool bForcePlaySound)
{
	...
	// Get array index InterpLocations with the lowest item count
